...
export default function TargetDetail({
  ...
  return (
    <div className="w-full bg-white rounded-xl shadow-lg p-4 space-y-4">
      {/* Top section with map and location */}
      <div className="flex items-start gap-4">
        {/* Map thumbnail */}
        <div className="w-40 h-32 bg-teal-600 rounded-lg overflow-hidden relative shrink-0">
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="relative">
            <div className="h-6 bg-gradient-to-r from-green-400 via-yellow-400 via-orange-400 to-red-500 rounded-full overflow-hidden" />
        ...
        {/* Temperature and close button section */}
        <div className="flex flex-col items-end gap-2">
          {temperature && (
            <div className="flex items-center gap-1">
              ...
              <span className="text-gray-600 text-sm">{temperature}°C</span>
            </div>
          )}
